...
const CodeEditor = () => {
    ...
    // Language auto completion and auto suggestions
    ...
    return (
        <div id="editor" className="md:p-4 p-2 " style={{ backgroundImage: "linear-gradient(135deg, #fdfcfb 0%, #e2d1c3 100%)" }}>
            ...
            <div className="controlers flex gap-2 w-full justify-start px-2 py-4 items-center">
                ...
                <div className="language w-36 ">
                    <select
                        ...
                        value={language}
                        id="languages" className="cursor-pointer bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    >
                ...
                <div className="theme w-36 ">
                    <select
                        ...
                        id="theme" className="cursor-pointer bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    >
                        {/* In-build themes */}
            ...
            <div className="flex h-[90vh] my-2">
                ...
                <NavigationPanel
                    ...
                    newlyAddedLink={newlyAddedLink} setnewlyAddedLink={setnewlyAddedLink} />
                {/* Editor Content */}
                <div
                    ref={mainRef}
            ...
            <div id="input" className=" m-1 md:m-2 min-h-[20vh]">
                <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                    <div className="p-4 bg-white rounded-t-lg dark:bg-gray-800">
                        ...
                        <textarea name="inputArea" id="inputArea" rows="4" className="w-full px-0 text-sm text-gray-900 outline-0 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400 min-h-52" placeholder="Write Input..." required ></textarea>
                    </div>
            ...
            <div id="output" className=" min-h-32 bg-slate-200 p-4 md:m-2 m-1 mt-0 rounded-lg border-[1px] border-gray-700"></div>
        </div>
    );
};
