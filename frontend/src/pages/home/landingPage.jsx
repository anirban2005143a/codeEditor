...
const LandingPage = () => {
    ...
    return (
        <div id='landingPage' ref={landingRef} className=' min-h-screen bg-cover bg-right bg-[#000000] bg-blend-darken flex flex-col  '>
            <div className=" z-10 relative md:px-8 px-2 brandName  font-bold  pt-[100px] flex justify-end items-center gap-[50px]">
            ...
            <div className=" z-10 relative intoduction text-white text-[1.2rem] py-4 md:w-[60%] sm:w-[80%] w-[100%] md:px-8 px-4 pt-[150px] font-extralight">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sequi possimus dolores aut veniam necessitatibus totam laborum libero tempora,
            </div>
